...
const a = {
    1: "Простые проекты создаем за 1 день, премиальные сайты любой сложности — за 2-3 дня.",
    ...
    10: "Чтобы связаться с руководством оставьте заявку, архитектор NOLLY CEO, свяэется с вами."
};
